...
<code>/bio 123456789 password Hello Everyone!</code>

<code>/emote 123456789 password</code>

<code>/add 987654321 eyJhbGciOi...</code>
"""
    )
...
def bio(m):
    ...
    if len(p) < 4:
        return bot.reply_to(
            m,
            "Usage:\n<code>/bio uid pass bio_text</code>"
        )
...
def add(m):
    ...
    try:
        msg = bot.reply_to(m, "⏳ Sending Friend Request...")
